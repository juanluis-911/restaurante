...
import { Download, Share, Plus, ChevronRight, Bike, CheckCircle2 } from 'lucide-react'
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-slate-900">
        <div className="w-full max-w-sm space-y-6 text-center">
          ...
          <Link
            href="/driver"
            className="flex items-center justify-center gap-2 w-full py-3.5 rounded-2xl bg-white text-slate-900 font-bold text-base shadow-lg active:scale-95 transition-transform"
          >
            Entrar al portal
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 space-y-8">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <div>
              <p className="text-sm text-slate-400 font-medium uppercase tracking-widest mb-1">TuriEats</p>
          ...
          <div className="space-y-3">
              ...
              <div className="bg-white/10 rounded-2xl border border-white/10 p-4 space-y-3">
                ...
                <ol className="space-y-2.5">
                  <li className="flex items-start gap-2.5 text-sm text-slate-300">
                    ...
                    <span>Toca el botón <Share size={13} className="inline-block" /> <strong className="text-white">Compartir</strong> de Safari</span>
                  </li>
                  <li className="flex items-start gap-2.5 text-sm text-slate-300">
            ...
            {!canInstall && !isIOS && (
              <div className="bg-amber-900/40 border border-amber-700/50 rounded-2xl p-3 text-center">
                <p className="text-sm text-amber-300">Abre este enlace en Chrome o Safari para instalar la app.</p>
              </div>
            )}
